...
export const withSearch = (
  WrappedComponent: React.ComponentType<OptionsFormProps>,
) => {
    ...
    return (
      <div className="ws-flex ws-h-full ws-flex-col">
        ...
        <div className="ws-flex-grow ws-overflow-auto">
          <WrappedComponent {...props} options={filteredOptions} />
        </div>
      </div>
    );
  };
...
const SearchableOptionsForm = withSearch(OptionsForm);
export default SearchableOptionsForm;
